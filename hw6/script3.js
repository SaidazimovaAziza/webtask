...
for(var i=0; i<cars.length; i++){
	...
	this.img.src =cars[i].image_url; 
	var my_cars = document.getElementById("cars");

	my_cars.appendChild(this.img);
}
document.getElementById("cars").onclick = function(event){
	document.getElementById("sum").innerHTML = event.target. ;
}
